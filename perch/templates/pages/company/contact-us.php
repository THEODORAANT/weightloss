            ...
            <div class="">
                <div class="rounded-3xl border border-[#3328bf]/10 bg-white/80 p-8 shadow-2xl shadow-[#3328bf]/10 backdrop-blur-xl sm:p-10">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="space-y-2">
                            <h2 class="text-2xl font-semibold text-slate-900">How to reach us</h2>
                    ...
                    <div class="mt-6 space-y-3 text-sm text-slate-600">
                        <p><span class="font-semibold text-slate-900">Email:</span> <a class="text-[#3328bf] underline-offset-2 hover:underline" href="mailto:support@getweightloss.co.uk">support@getweightloss.co.uk</a></p>
                        <p><span class="font-semibold text-slate-900">Response time:</span> Within one working day</p>
                        <p><span class="font-semibold text-slate-900">Availability:</span> Monday&nbsp;&ndash;&nbsp;Friday, 9am&nbsp;&ndash;&nbsp;5pm</p>
                    </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div class="group h-full rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:border-[#3328bf] hover:shadow-xl">
                ...
                <h3 class="text-xl font-semibold text-slate-900">General enquiries</h3>
            ...
            <div class="group h-full rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:border-[#3328bf] hover:shadow-xl">
                ...
                <h3 class="text-xl font-semibold text-slate-900">Clinical support</h3>
                <p class="mt-4 text-base leading-relaxed text-slate-600">
            ...
            <div class="group h-full rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:border-[#3328bf] hover:shadow-xl">
                ...
                <h3 class="text-xl font-semibold text-slate-900">Feedback &amp; complaints</h3>
                <p class="mt-4 text-base leading-relaxed text-slate-600">
        ...
        <div class="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-[#3328bf] hover:shadow-lg">
                    <h3 class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Order tracking</h3>
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-[#3328bf] hover:shadow-lg">
                    <h3 class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Account &amp; billing</h3>
                    <p class="mt-4 text-sm leading-relaxed text-slate-600">
    ...
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div class="rounded-[28px] bg-gradient-to-r from-[#3328bf] to-[#22308c] px-8 py-12 text-white shadow-2xl sm:px-12">
            <div class="grid gap-8 lg:grid-cols-[2fr,1fr] lg:items-center">
                <div class="space-y-4">
                    <h2 class="text-3xl font-semibold sm:text-4xl">Prefer to talk things through?</h2>
