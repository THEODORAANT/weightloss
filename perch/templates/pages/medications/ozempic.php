    ...
    <div id="hero" class="w-full flex flex-col items-center justify-center bg-white">
      <div class="bg-white flex flex-col lg:flex-row items-center justify-between w-full">
        <div class="h-[400px] md:h-[550px] lg:h-[700px] w-full lg:w-[704px] order-2 lg:order-1">
          <img src="/asset/123.webp" alt="Mounjaro Injection" class="w-full h-full object-cover" />
        </div>
        <div class="flex flex-col gap-[24px] lg:gap-[32px] items-start px-[20px] md:px-[40px] lg:pl-[15px] lg:pr-[160px] py-[40px] lg:py-0 w-full lg:w-[719px] order-1 lg:order-2">
          <div class="flex flex-col gap-[16px] lg:gap-[20px] items-start w-full">
            <h1 class="font-semibold text-[#0d0d0d] text-[36px] md:text-[56px] lg:text-[72px] tracking-[-0.72px] md:tracking-[-1.12px] lg:tracking-[-1.44px] leading-[44px] md:leading-[68px] lg:leading-[90px]">Ozempic®: A Proven Treatment for Type 2 Diabetes</h1>
          </div>
          <div class="flex flex-col gap-[16px] lg:gap-[20px] items-start w-full">
      ...
      <div class="flex flex-col md:flex-row gap-[16px] md:gap-[23px] items-start md:items-center justify-between px-[20px] md:px-[40px] lg:px-0 pb-[40px] lg:pb-[50px] pt-[30px] lg:pt-[50px] w-full max-w-[1120px]">
        <div class="flex gap-[16px] md:gap-[20px] items-center w-full md:w-auto">
          ...
          <p class="font-normal leading-[24px] text-[16px] text-[grey]">Stimulating insulin secretion</p>

        </div>
        <div class="flex gap-[16px] md:gap-[20px] items-center w-full md:w-auto">
          <img src="/new/images/common/gwl-bullet.svg" alt="bullet" class="w-[32px] h-[32px] md:w-[36px] md:h-[36px] flex-shrink-0" />
          <p class="font-normal leading-[24px] text-[16px] text-[grey]">Reducing glucagon production </p>
        </div>
        <div class="flex gap-[16px] md:gap-[20px] items-center w-full md:w-auto">
          <img src="/new/images/common/gwl-bullet.svg" alt="bullet" class="w-[32px] h-[32px] md:w-[36px] md:h-[36px] flex-shrink-0" />
          <p class="font-normal leading-[24px] text-[16px] text-[grey]">Slowing gastric emptying</p>
        </div>
      </div>
    </div>
        ...
        <div class="flex flex-col gap-[24px] lg:gap-[32px] items-center justify-center px-[20px] md:px-[40px] lg:px-[60px] py-[60px] md:py-[80px] lg:py-[100px] w-full lg:max-w-[1120px]">
          <div class="flex flex-col lg:flex-row gap-[40px] lg:gap-[60px] items-start w-full">
            ...
            <div class="flex flex-col gap-[16px] w-full">
             <p class="font-normal leading-[24px] text-[16px] text-[grey]">Ozempic® (semaglutide) is a once-weekly injectable medication designed to help adults with type 2 diabetes manage their blood sugar levels. As a GLP-1 receptor agonist, it works by stimulating insulin secretion; reducing glucagon production and slowing gastric emptying.
                          </p>
            <p class="font-normal leading-[24px] text-[16px] text-[grey]">All this helps to manage blood sugar levels. This combination of effects also supports weight loss, making it a valuable tool for those aiming to reduce body weight and improve metabolic health.
            </p>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-[32px] items-center justify-center px-[20px] md:px-[40px] lg:px-[60px] py-[60px] md:py-[80px] lg:py-[100px] w-full lg:max-w-[1120px]">
          <div class="flex flex-col gap-[20px] lg:gap-[30px] items-start w-full lg:w-[544px]">
            <div class="flex flex-col gap-[16px] lg:gap-[20px] items-start w-full">
              ...
              <div class="flex flex-col gap-[16px] w-full">
                <p class="font-normal leading-[24px] text-[16px] text-[grey]">When using Ozempic, you are injecting a medication called semaglutide.Here's what it involves: </p>
  <p class="leading-[24px] text-[16px] text-[grey]"><span class="font-bold">Semaglutide: </span>The active ingredient in Ozempic, a GLP-1 receptor agonist. </p>
  <p class="leading-[24px] text-[16px] text-[grey]"><span class="font-bold">Subcutaneous Injection: </span>Administered once a week via a small needle under the skin.
                   </p>
  <p class="leading-[24px] text-[16px] text-[grey]"><span class="font-bold">Easy to Use: </span>Comes with a pre-filled pen for convenient, self-administration.
                   </p>
              </div>
            </div>
          </div>
          <div class="h-[300px] md:h-[400px] lg:h-[450px] w-full lg:w-[544px] rounded-[20px] overflow-hidden">
            <img src="/asset/clinically-12.webp" alt="Mounjaro Injection" class="w-full h-full object-cover" />
          </div>
        </div>
      </div>
      ...
      <div class="w-full flex flex-col items-center justify-center">
        <div class="flex flex-col lg:flex-row gap-[32px] items-center justify-center px-[20px] md:px-[40px] lg:px-[60px] py-[60px] md:py-[80px] lg:py-[100px] w-full lg:max-w-[1120px]">
          <div class="h-[300px] md:h-[400px] lg:h-[450px] w-full lg:w-[544px] rounded-[20px] overflow-hidden order-2 lg:order-1">
            <img src="/asset/clinically-13.webp" alt="Side Effects" class="w-full h-full object-cover" />
          </div>
          <div class="flex flex-col gap-[20px] lg:gap-[30px] items-start w-full lg:w-[544px] order-1 lg:order-2">
            <div class="flex flex-col gap-[16px] lg:gap-[20px] items-start w-full">
              ...
              <div class="flex flex-col gap-[16px] w-full">
                <p class="font-normal leading-[24px] text-[16px] text-[grey]">Ozempic may cause some side effects, though they aren't experienced by everyone. Potential side effects include:</p>
                 <p class="leading-[24px] text-[16px] text-[grey]"><span class="font-bold">Nausea and Vomiting: </span>Common, especially when starting treatment.</p>
                  <p class="leading-[24px] text-[16px] text-[grey]"><span class="font-bold">Digestive Issues:</span> Diarrhea, constipation, or stomach pain.</p>
                  <p class="leading-[24px] text-[16px] text-[grey]"><span class="font-bold">Headache and Fatigue: </span>May occur during initial use.</p>
                 <p class="leading-[24px] text-[16px] text-[grey]"><span class="font-bold">Risk of Low Blood Sugar:</span> When combined with other diabetes medications.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="w-full flex flex-col items-center justify-center">
      <div class="bg-white flex flex-col items-center justify-center px-[20px] md:px-[40px] lg:px-[60px] py-0 w-full">
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-[32px] lg:gap-0 px-0 pt-[30px] md:pt-[40px] lg:pt-[50px] pb-[60px] md:pb-[80px] lg:pb-[100px] w-full lg:max-w-[1120px]">
          <p class="font-medium text-[#0d0d0d] text-[32px] md:text-[40px] lg:text-[48px] tracking-[-0.64px] md:tracking-[-0.8px] lg:tracking-[-0.96px] leading-[40px] md:leading-[50px] lg:leading-[60px] w-full lg:w-[544px]">Let's Find Your Perfect Treatment Together</p>
