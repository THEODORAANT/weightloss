    ...
    <footer id="contact" class="bg-[#324ea0] w-full flex flex-col items-center justify-center">
          ...
          <div class="flex flex-col gap-[16px] items-start">
            ...
            <div class="flex flex-col gap-[12px] items-start leading-[24px] text-[14px] md:text-[16px] text-white w-full">
              <a href="https://getweightloss.co.uk/weightloss_treatments" class="hover:text-[#afd136] transition-colors">Treatments</a>
               <a href="https://getweightloss.co.uk/order/addons" class="hover:text-[#afd136] transition-colors"> Blood Tests</a>
      ...
      s1.async=true;
      s1.src='https://embed.tawk.to/69bd54cf9b146b1c3a117181/1jk5p6iiq';
      s1.charset='UTF-8';
